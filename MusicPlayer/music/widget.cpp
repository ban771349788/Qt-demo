    ...
    ui(new Ui::Widget)
{
    ...
    ui->lineEdit->setPlaceholderText(QString::fromUtf8("输入歌手或歌曲"));
    ui->label_5->setText(QString::fromUtf8("长胖的土豆"));
...
inline void Widget::init_else()
{
    ...
    if(FileName.isEmpty())
    {
        pix.load(":/image/image/background/bg1.jpg");
    }
    else
    {
        pix.load(FileName);
...
inline void Widget::init_win()
{
    ...
    next->setToolTip(QString::fromUtf8("下一首"));
    ...
    pre->setToolTip(QString::fromUtf8("上一首"));
    ...
    pause->setToolTip(QString::fromUtf8("暂停"));
...
inline void Widget::init_tooltip()
{
    ...
    ui->pushButton->setToolTip(QString::fromUtf8("添加歌曲"));
    ui->pushButton_2->setToolTip(QString::fromUtf8("暂停"));
    ui->pushButton_3->setToolTip(QString::fromUtf8("下一首"));
    ui->pushButton_4->setToolTip(QString::fromUtf8("上一首"));
    ui->pushButton_5->setToolTip(QString::fromUtf8("设置"));
    ui->pushButton_6->setToolTip(QString::fromUtf8("更换皮肤"));
    ui->pushButton_7->setToolTip(QString::fromUtf8("定位"));
    ui->pushButton_8->setToolTip(QString::fromUtf8("音量"));
    ui->pushButton_9->setToolTip(QString::fromUtf8("顺序播放"));
    ui->pushButton_10->setToolTip(QString::fromUtf8("本地音乐"));
    ui->pushButton_11->setToolTip(QString::fromUtf8("我喜欢"));
    ui->pushButton_12->setToolTip(QString::fromUtf8("我的收藏"));
    ui->pushButton_13->setToolTip(QString::fromUtf8("切换至极简模式/双击"));
    ui->pushButton_15->setToolTip(QString::fromUtf8("隐藏播放列表"));
    ui->pushButton_17->setToolTip(QString::fromUtf8("关闭"));
    ui->pushButton_16->setToolTip(QString::fromUtf8("最小化"));
}
...
inline void Widget::init_action()
{
    ...
    action1->setText(QString::fromUtf8("添加至本地音乐"));
    ...
    action2->setText(QString::fromUtf8("添加至我喜欢"));
    ...
    action3->setText(QString::fromUtf8("添加至我的收藏"));
    ...
    ClearALL_2->setText(QString::fromUtf8("清除我喜欢列表"));
    ...
    ClearALL_3->setText(QString::fromUtf8("清除我的收藏"));
    ...
    ClearALL_4->setText(QString::fromUtf8("清除所有列表"));
    ...
    ClearHistory->setText(QString::fromUtf8("清除历史记录"));
    ...
    action13->setText(QString::fromUtf8("退出"));

    detila   = new QAction(this);//歌曲详情
    detila->setIcon(QIcon(":/image/image/inf.png"));
    detila->setText(QString::fromUtf8("歌曲信息"));
}
...
void Widget::updateInfo()//更新文本
{
    ...
    if(music->playlist() == playlist_2)
    {
        ...
        ui->pushButton_14->setToolTip(QString::fromUtf8("我喜欢"));
    }
    else if(music->playlist() == playlist_3)
    {
        ...
        ui->pushButton_14->setToolTip(QString::fromUtf8("我的收藏"));
    ...
    else if(music->playlist() == playlist_4)
    {
        ui->pushButton_14->setIcon(QIcon(":/image/image/image/music.png"));
        ui->pushButton_14->setStyleSheet(MusicListStyle());
        ui->pushButton_14->setToolTip(QString::fromUtf8("播放历史"));
    }
    else
    {
        //判断该歌曲是不是我喜欢歌曲
        ...
        else
        {
            ui->pushButton_14->setIcon(QIcon(":/image/image/image/Ilike.png"));
            ui->pushButton_14->setStyleSheet(IlikeStyle());
            ui->pushButton_14->setToolTip(QString::fromUtf8("添加至我喜欢"));
        }
...
void Widget::detila_slot()//歌曲详情
{
    ...
    if(music->playlist() == playlist)
    {
        ...
        QMessageBox::about(this,QString::fromUtf8("歌曲信息"),QString::fromUtf8("歌曲名 : %1  \n"
                                                                            "作者 : %2 \n"
                                                                            "时长 : %3 \n"
...
{
    int values = QMessageBox::information(this, QString::fromUtf8("清除本地音乐列表"), QString::fromUtf8("确定清除本地音乐列表?                              ."),QMessageBox::Yes|QMessageBox::No,QMessageBox::No);
...
void Widget::ClearHistory_Slot()//清除所有历史记录
{
    int values = QMessageBox::information(this,QString::fromUtf8("清除历史记录"),QString::fromUtf8("确定清除所有历史记录?                              ."),QMessageBox::Yes|QMessageBox::No,QMessageBox::No);
    if(values == QMessageBox::Yes)
    {
        ui->listWidget_5->clear();
        playlist_4->clear();
...
{
    int values = QMessageBox::information(this,QString::fromUtf8("清除我喜欢列表"),QString::fromUtf8("确定清除我喜欢列表?                              ."),QMessageBox::Yes|QMessageBox::No,QMessageBox::No);
    if(values == QMessageBox::Yes)
    {
        QSqlQuery query;
        query.exec("select * from LikeMusic");
...
{
    int values = QMessageBox::information(this,QString::fromUtf8("清除我的收藏"),QString::fromUtf8("确定清除我的收藏?                              ."),QMessageBox::Yes|QMessageBox::No,QMessageBox::No);
    if(values == QMessageBox::Yes)
    {
        QSqlQuery query;
        query.exec("select * from CollectMusic");
...
{
    int values = QMessageBox::information(this,QString::fromUtf8("清除所有列表"),QString::fromUtf8("确定清除所有列表?                              ."),QMessageBox::Yes|QMessageBox::No,QMessageBox::No);
    if(values == QMessageBox::Yes)
    {
        QSqlQuery query;
        query.exec("delete from LocalMusic");
...
void Widget::action1_slot()//添加菜单  添加至本地音乐
{
    ...
    QSqlQuery query;
    query.exec("select * from LocalMusic");
    QStringList list = QFileDialog::getOpenFileNames(this,QString::fromUtf8("文件"),currentFileName[1],QString::fromUtf8("音频文件(*.mp3)"));
    if(!list.isEmpty())
    {
        //进度条对话框
        ...
        progressdialog->setWindowTitle(QString::fromUtf8("添加歌曲"));
        progressdialog->setLabelText(QString::fromUtf8("正在添加,请稍后."));
        ...
        button->setText(QString::fromUtf8("关闭"));
...
void Widget::action2_slot()//添加菜单  添加至我喜欢
{
    ...
    QSqlQuery query;
    query.exec("select *from LikeMusic");
    QStringList list = QFileDialog::getOpenFileNames(this,QString::fromLocal8Bit("所有文件"),currentFileName[2],QString::fromLocal8Bit("音频文件(*.mp3)"));
    if(!list.isEmpty())
   {//进度条对话框
        QProgressDialog *progressdialog=new QProgressDialog(this);
    progressdialog->setWindowModality(Qt::WindowModal);
    ...
    progressdialog->setMaximumSize(400,120);
    progressdialog->setMinimumDuration(100);
    progressdialog->setWindowTitle(QString::fromLocal8Bit("添加歌曲"));
    progressdialog->setLabelText(QString::fromLocal8Bit("正在添加,请稍后."));
    QPushButton *button=new QPushButton(this);
    QPixmap pixmap;
    pixmap.load(":/image/image/58d4d135e7bce713bd501050.jpg");
    QPalette palette;
...
void Widget::action3_slot()//添加菜单  添加至我的收藏
{
  ...
  pushbuttonstyle_3();
    QSqlQuery query;
    query.exec("select *from  CollectMusic");
    QStringList list = QFileDialog::getOpenFileNames(this,QString::fromLocal8Bit("所有文件"),currentFileName[3],QString::fromLocal8Bit("音频文件(*.mp3)"));
   if(!list.isEmpty())
   {
       //进度条对话框
    QProgressDialog *progressdialog=new QProgressDialog(this);
...
{
    ListFocus();
    QString FileName = ":/image/image/background/bg1.jpg";
    QSqlQuery query;
...
{
    ListFocus();
    QString FileName = ":/image/image/background/bg2.jpg";
    QSqlQuery query;
    query.exec("delete from WALLPAPER_DATA");
    query.exec(QString("insert into WALLPAPER_DATA values('%1')").arg(FileName));
    pix.load(FileName);
...
{
    ListFocus();
    QString FileName = QFileDialog::getOpenFileName(this, QString::fromUtf8("文件"), currentFileName[0], QString::fromUtf8("图片文件(*jpg *png)"));
    if(!FileName.isEmpty())
    {
...
{
    ListFocus();
    QMessageBox::about(this, QString::fromUtf8("关于"), QString::fromUtf8(
                           "名称 : 我的音乐                         \n"
                           "作者 : 长胖的土豆                           \n"
...
{
    QMessageBox::about(this, QString::fromUtf8("使用"), QString::fromUtf8("右键 : 菜单栏              Esc : 退出程序\n"
...
void Widget::action12_2_slot()//主窗口右键菜单 随机播放
{
    ...
    ui->pushButton_9->setToolTip(QString::fromUtf8("随机播放"));
...
void Widget::action12_3_slot()//主窗口右键菜单 单曲循环
{
    ...
    ui->pushButton_9->setToolTip(QString::fromUtf8("单曲循环"));
...
void Widget::on_pushButton_2_clicked()//播放/暂停
{
    ...
    else
    {
        ...
        pause->setToolTip(QString::fromUtf8("播放"));
...
void Widget::on_pushButton_15_clicked()//隐藏stackedWidget
{
    ...
    else
    {
        ...
        ui->pushButton_15->setToolTip(QString::fromUtf8("显示播放列表"));
...
void Widget::Action2_slot()//listWidget_3右键菜单 添加至我喜欢
{
    if(ui->listWidget_3->selectionMode() == QListWidget::SingleSelection)
    {
        ...
        {
            QMessageBox::information(this,QString::fromUtf8("提示"),QString::fromUtf8("该歌曲已添加                              ."),QMessageBox::Yes);
        }
    }
    else if(ui->listWidget_3->selectionMode() == QListWidget::MultiSelection)
    {
        ...
        progressdialog->setMaximumSize(400,120);
        progressdialog->setMinimumDuration(100);
        progressdialog->setWindowTitle(QString::fromUtf8("添加至我喜欢"));
        progressdialog->setLabelText(QString::fromUtf8("正在添加,请稍后."));
        QPushButton *button = new QPushButton(this);
        QPixmap pixmap;
        pixmap.load(":/image/image/58d4d135e7bce713bd501050.jpg");
...
void Widget::Action4_slot()//listWidget_3右键菜单 添加至我的收藏
{
    ...
    else if(ui->listWidget_3->selectionMode() == QListWidget::MultiSelection)
    {
        ...
        progressdialog->setMaximumSize(400,120);
        progressdialog->setMinimumDuration(100);
        progressdialog->setWindowTitle(QString::fromUtf8("添加至我的收藏"));
        progressdialog->setLabelText(QString::fromUtf8("正在添加,请稍后."));
...
void Widget::Action3_slot()//listWidget_3右键菜单 删除
{
    ...
    else if(ui->listWidget_3->selectionMode()==QListWidget::MultiSelection)
    {
        ...
        progressdialog->setMaximumSize(400,120);
        progressdialog->setMinimumDuration(100);
        progressdialog->setWindowTitle(QString::fromUtf8("删除"));
        progressdialog->setLabelText(QString::fromUtf8("正在删除,请稍后."));
...
void Widget::on_listWidget_2_customContextMenuRequested(const QPoint &pos)//listWidget_2右键菜单 我喜欢列表
{
    ...
    Action1_2->setText(QString::fromUtf8("播放"));
    ...
    Action1_2_1->setText(QString::fromUtf8("暂停"));
    ...
    Action2_2->setText(QString::fromUtf8("移除"));
    ...
    Action3_2->setText(QString::fromUtf8("添加至我的收藏"));
    ...
    Action4_2->setText(QString::fromUtf8("歌曲信息"));
    ...
    Action6_2->setText(QString::fromUtf8("多选"));
    ...
    Action7_2->setText(QString::fromUtf8("取消多选"));
...
void Widget::Action4_2_slot()//歌曲信息
{
    ...
    QMessageBox::about(this,QString::fromUtf8("歌曲信息"),
                       QString::fromUtf8("歌曲名 : %1  \n"
                                         "作者 : %2 \n"
                                         "时长 : %3 \n"
                                         "文件路径 : %4\n").arg(MusicName).arg(Author).arg(time).arg(FileName));
}
...
void Widget::Action2_2_slot()//listWidget_2右键菜单 删除
{
    ...
    else if(ui->listWidget_2->selectionMode() == QListWidget::MultiSelection)
    {
        ...
        progressdialog->setMaximumSize(400,120);
        progressdialog->setMinimumDuration(100);
        progressdialog->setWindowTitle(QString::fromUtf8("移除"));
        progressdialog->setLabelText(QString::fromUtf8("正在移除,请稍后."));
...
void Widget::on_listWidget_customContextMenuRequested(const QPoint &pos)//listWidget右键菜单  我的收藏
{
    ...
    Action1_3->setText(QString::fromUtf8("播放"));
    ...
    Action1_3_1->setText(QString::fromUtf8("暂停"));
    ...
    Action2_3->setText(QString::fromUtf8("移除"));
    ...
    Action3_3->setText(QString::fromUtf8("歌曲信息"));
    ...
    Action5_3->setText(QString::fromUtf8("多选"));
    ...
    Action6_3->setText(QString::fromUtf8("取消多选"));
...
void Widget::on_listWidget_4_customContextMenuRequested(const QPoint &pos)//listWidget_4 菜单 搜索列表
{
    ...
    Action_A->setText(QString::fromUtf8("暂停"));
    ...
    Action1->setText(QString::fromUtf8("添加至我喜欢"));
    ...
    Action4->setText(QString::fromUtf8("歌曲信息"));
