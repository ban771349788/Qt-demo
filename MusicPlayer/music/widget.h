...
protected:
    ...
    void mouseDoubleClickEvent(QMouseEvent *);//双击切换至极简模式
...
private:
    ...
    QMediaPlaylist *playlist;//播放列表1
    QMediaPlaylist *playlist_2;//播放列表2
    QMediaPlaylist *playlist_3;//播放列表3
    QMediaPlaylist *playlist_4;//历史
